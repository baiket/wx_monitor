<!-- settings -->
  ...
  <div class="panel-heading">
    <a class="pull-right btn btn-xs btn-rounded btn-danger" href="http://themeforest.net/item/angulr-bootstrap-admin-web-app-with-angularjs/8437259?ref=flatfull">BUY</a>
    Settings
  </div>
